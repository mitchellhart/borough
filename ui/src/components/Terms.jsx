      ...
      <div className="space-y-6">
        <section>
          ...
          <p className="text-gray-600">
            By accessing and using Boro's services, you agree to be bound by these Terms of Service. 
        ...
        <section>
          ...
          <p className="text-gray-600">
            Boro provides AI-powered analysis of home inspection reports. Our service is provided 
        ...
        <section>
          ...
          <p className="text-gray-600">
            Your use of Boro's services is also governed by our Privacy Policy. Please review 
        ...
        <section>
          ...
          <p className="text-gray-600">
            ...
            <a href="mailto:help@Boro-ai.com" className="text-blue-600 hover:underline">
              help@Boro-ai.com
            </a>
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-600">
            Boro is a subscription-based service billed monthly. You may cancel your subscription at any time 
        ...
        <section>
          ...
          <p className="text-gray-600">
            ...
            Users are responsible for ensuring their use of Boro's services complies with all applicable 
        ...
        <section>
          ...
          <p className="text-gray-600">
            Currently, Boro does not offer any promotional programs. Any future promotions, discounts, 
